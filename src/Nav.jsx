  ...
  render() {
    return (
        <div>
          ...
          <a target="_self" className={"homeSeoLink"} href={"https://leonardobadilla.com"}>home</a>
          <a target="_self" className={"homeSeoLink"} href={"https://leonardobadilla.com/about"}>About</a>
          <a target="_self" className={"homeSeoLink"} href={"https://leonardobadilla.com/resume"}>Curriculum</a>
        </div>
    );
  }
}
